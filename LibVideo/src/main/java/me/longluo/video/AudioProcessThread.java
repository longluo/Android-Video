    ...
    private void doProcessAudio() throws Exception {
        ...
        if (audioTrackIndex >= 0) {
            ...
            if (mSpeed != null || !inputMimeType.equals(outputMimeType)) {
                AudioUtils.writeAudioTrackDecode(mContext, mExtractor, mMuxer, mMuxerAudioTrackIndex, startTimeUs, endTimeUs,
                        mSpeed == null ? 1f : mSpeed, this);
            } else {
                AudioUtils.writeAudioTrack(mExtractor, mMuxer, mMuxerAudioTrackIndex, startTimeUs, endTimeUs, this);
            }
        }
