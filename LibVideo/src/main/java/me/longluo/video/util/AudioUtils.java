...
import me.longluo.video.math.SSRC;
...
public class AudioUtils {
    ...
    public final static String TAG = "VideoProcessor";
    ...
    public static void adjustAacVolume(Context context, VideoProcessor.MediaSource aacSource, String outPath, int volume
        ...
        AudioUtils.decodeToPCM(aacSource, pcmFile.getAbsolutePath(), null, null);
        ...
        new PcmToWavUtils(sampleRate, channelConfig, oriChannelCount, AudioFormat.ENCODING_PCM_16BIT).pcmToWav(pcmFile2.getAbsolutePath(), wavFile.getAbsolutePath());
                ...
                if (!decodeInputDone) {
                    ...
                    if (decodeInputIndex >= 0) {
                        ...
                        if (eof) {
                            ...
                            Timber.i("audio decode queueInputBuffer " + info.presentationTimeUs / 1000);
                ...
                while (!decodeDone) {
                    ...
                    if (outputBufferIndex == MediaCodec.INFO_TRY_AGAIN_LATER) {
                        ...
                        if (info.flags == MediaCodec.BUFFER_FLAG_END_OF_STREAM) {
                            ...
                            Timber.i( "audio decode saveFrame " + info.presentationTimeUs / 1000);
    ...
    public static long writeAudioTrack(MediaExtractor extractor, MediaMuxer mediaMuxer, int muxerAudioTrackIndex,
        ...
        while (true) {
            ...
            Timber.i("writeAudioSampleData,time:" + info.presentationTimeUs / 1000f);
    ...
    public static void writeAudioTrackDecode(Context context, MediaExtractor extractor, MediaMuxer mediaMuxer, int muxerAudioTrackIndex,
        ...
        new PcmToWavUtils(sampleRate, channelConfig, oriChannelCount, AudioFormat.ENCODING_PCM_16BIT).pcmToWav(pcmFile.getAbsolutePath(), wavFile.getAbsolutePath());
        //开始处理pcm
        Timber.i("start process pcm speed");
